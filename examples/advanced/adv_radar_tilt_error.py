# Radar station: how the 1-2 deg battlefield tilt breaks a flat-ground homography.
#
...
# 15 m wide, so the worst-case lateral offset from the central axis is 7.5 m and
#       dz = 7.5 * tan(theta).
...
ax.set_ylabel("horizontal position error  e = R·Δz/h  [m]")
ax.set_title("Flat-ground homography vs the 1–2° field tilt  —  DERIVED, not measured\n"
             "at 2° the 'accurate' budget is spent by 7.6 m; the whole far field falls out",
...
fig.text(0.012, 0.012,
         "Δz = 7.5·tan θ  (half field width);  e ≈ R·Δz/h.  "
